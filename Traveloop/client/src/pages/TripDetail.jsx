        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-[#020617]/40 to-transparent flex flex-col justify-end p-12">
          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-6xl font-black text-white tracking-tight">{trip.name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-10">
          <div className="flex items-center justify-between">
            <h2 className="text-4xl font-black text-white tracking-tight">The Itinerary</h2>
            <button 
        ...
        <div className="space-y-8">
             ...
             <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-end mb-3">
                    <span className="text-slate-400 font-bold text-sm">Estimated Spend</span>
                    <span className="text-2xl font-black text-white">₹0.00</span>
                  </div>
                  <div className="h-3 w-full bg-white/5 rounded-full overflow-hidden border border-white/5">
                    <div className="h-full bg-gradient-to-r from-primary-600 to-primary-400 w-0 rounded-full"></div>
                  </div>
                </div>
          ...
          <div className="glass p-8 space-y-6 border-white/5">
            ...
            <div className="grid grid-cols-1 gap-4">
               {[
                 { icon: Luggage, label: 'Packing List', color: 'text-blue-400', path: '/checklist' },
                 { icon: BookOpen, label: 'Trip Journal', color: 'text-purple-400', path: '/checklist' },
          ...
          >
            ...
            <h4 className="font-black text-white mb-3 uppercase tracking-tighter text-xl">Intelligence Suggestion</h4>
            <p className="text-slate-300 text-sm font-medium leading-relaxed">
              Based on your destination of <span className="text-primary-400 font-bold">{trip.destination}</span>, we recommend booking local experiences at least 2 weeks in advance to secure the best rates.
            </p>
            <button 
              onClick={() => toast.success('Analyzing travel market data...')}
